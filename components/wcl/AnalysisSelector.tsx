...
const AnalysisSelector = ({
    ...
    return (
        <div className="flex flex-col gap-4 min-h-64 border-b border-white select-none pb-4">
            <div className="flex items-start gap-4">
                ...
                <div className="flex flex-wrap gap-2">
                    {bosses.map(b => (
                        <div
                            key={b.id}
                            className={`grid place-items-center text-lg px-2 py-1 cursor-pointer border border-white rounded ${
                                boss === b.id
                                    ? "border-opacity-20 bg-blue-900 bg-opacity-50"
                                    : "border-opacity-20"
                            }`}
                            onClick={() => {
                                if (boss === b.id) return;
